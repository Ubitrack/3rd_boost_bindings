...
### Basic setup
    ...
    $ conan install ubitrack_boost_bindings/1.0@camposs/stable
...
## Upload packages to server
    ...
    $ conan upload ubitrack_boost_bindings/1.0@camposs/stable --all -r ubitrack    

## Notes

If you have trouble linking to the lapack libraries, check boost/numeric/bindings/traits/fortran.h 
